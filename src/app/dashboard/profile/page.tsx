...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-6">
            ...
            {editing ? (
                ...
                {currentUser?.role === 'intern' && (
                  <>
                    <div className="border-t pt-4">
                      <h3 className="text-sm font-semibold text-gray-900 mb-4">Internship Details</h3>
                      <div className="grid gap-4 md:grid-cols-2">
                        <div>
                        ...
                        <div className="md:col-span-2">
                          <label className="text-sm font-semibold text-gray-700 mb-2 block">Internship Role</label>
                          <Input
              ...
              <div className="space-y-6">
                ...
                {currentUser?.role === 'intern' && (profile.college || profile.department || profile.internshipRole) && (
                  <div className="border-t pt-4">
                    <h3 className="text-sm font-semibold text-gray-900 mb-3">Internship Details</h3>
                    <div className="grid gap-4 md:grid-cols-2">
                      {profile.college && (
                        <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
      ...
      {/* Performance Overview (For Interns) */}
      {currentUser?.role === 'intern' && (
