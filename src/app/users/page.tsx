...
interface User {
  ...
  email: string;
  role: 'admin' | 'intern';
  internId?: string; // Unique intern ID
  department?: string;
  position?: string;
  phone?: string;
  startDate?: string;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Manage admins and interns</p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="border-0 shadow-md">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground">Interns</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <Card className="border-0 shadow-2xl">
              ...
              <CardContent className="pt-6 bg-white">
                <form onSubmit={editingUser ? handleUpdateUser : handleCreateUser} className="space-y-6">
                  ...
                  {/* Internship Details (only for interns) */}
                  {formData.role === 'intern' && (
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4 border-b pb-2">Internship Details</h3>
                      <div className="grid gap-4 md:grid-cols-2">
                        <div>
                          <label className="text-sm font-semibold text-gray-700 mb-2 block">
                            Start Date
