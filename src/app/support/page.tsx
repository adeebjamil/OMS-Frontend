          ...
          <div className="space-y-6">
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent className="pt-6 space-y-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">How do I share documents with interns?</h4>
                  <p className="text-sm text-gray-600">
                    Click the share icon on any document, select the intern and access level, then click "Share Document".
                  </p>
                </div>
                <div>
